...
import MovieList from "../movie-list/MovieList";
 ...
 export default function Genres() {
     ...
     const fetchMovies = async () => {
         try {
             const { data } = await axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=true&page=${currentPage}&with_genres=${genresIds}`);
